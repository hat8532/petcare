...
public class DiagnosisService {
    ...
    public DiagnosisResultResponse analyzeDiagnosis(DiagnosisAnalyzeRequest request, MultipartFile image) {
        ...
        List<String> symptoms = request.symptoms();
        ...
        DiagnosisRecordDTO record = DiagnosisRecordDTO.builder()
                ...
                .symptomsJson(writeJson(symptoms))
    ...
    private String writeJson(Object value) {
        try {
            ...
            throw new IllegalStateException("진단 요청을 저장 형식으로 변환할 수 없습니다.", exception);
        }
    }
    ...
    private String buildDiseasesJson(String area, String topDisease) {
        ...
        return String.format(
                "[{\"diseaseName\":\"%s\",\"probability\":86.4},{\"diseaseName\":\"%s\",\"probability\":9.5},{\"diseaseName\":\"%s\",\"probability\":4.1}]",
